...
namespace FlashWish.Api.Controllers
{
    ...
    public class TemplatesController : ControllerBase
    {
        ...
        public async Task<ActionResult<TemplateDTO>> PostAsync([FromForm] TemplatePostModelPost template)
        {
        ...
        public async Task<ActionResult<TemplateDTO>> PutAsync(int id, [FromBody] TemplatePostModelPut template)
        {
            //if (template == null)
            //{
            //    return BadRequest();//400
        ...
        public async Task<ActionResult> DeleteAsync(int id) // הפונ רק מסמנת את התמונה כמיועדת למחיקה.
        {
            ...
            //}
            var isMarkedForDeletion = await _templateService.MarkTemplateForDeletionAsync(id);
